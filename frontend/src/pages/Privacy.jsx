  ...
  return (
    <div className="container">
      <div className="prose">
        ...
        <p>
          Payments are processed through a third-party provider. We do not store credit card
          numbers or payment details on our servers.
        </p>
        <p>Payment processing services are provided by <strong>Stripe</strong>.</p>
        ...
        <p>
          Files uploaded by users are stored for the purpose of providing the service. Users are
          responsible for ensuring they have the legal right to upload the content.
        </p>

        <h2>6. Third-Party Services</h2>
        <p>
          Our platform may rely on third-party services such as authentication providers and
          payment processors. These services have their own privacy policies governing the use of
          your information.
        </p>
